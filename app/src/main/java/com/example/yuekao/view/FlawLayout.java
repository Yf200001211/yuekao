...
public class FlawLayout extends ViewGroup {
     ...
     * @return 返回子元素总所占宽度和高度（用于计算FlawLayout的AT_MOST模式设置宽高）
     */
    private Map<String, Integer> compute(int flowWidth) {
        ...
        //返回子元素总所占宽度和高度（用于计算FlawLayout的AT_MOST模式设置宽高）
        ...
        //FlawLayout测量高度 = 当前行顶部已占高度 +当前行内子元素最大高度+FlawLayout的PaddingBottom
